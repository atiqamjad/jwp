 ...
 */
@Entity
@Table(name = "wp_links", catalog = "gads_wp")
public class WpLinks implements java.io.Serializable {
    ...
    public WpLinks(String linkUrl, String linkName, String linkImage, String linkTarget,
            String linkDescription, String linkVisible, long linkOwner, int linkRating,
            Date linkUpdated, String linkRel, String linkNotes, String linkRss) {
