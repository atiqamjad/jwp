 ...
 */
@Entity
@Table(name = "wp_comments", catalog = "gads_wp")
public class WpComments implements java.io.Serializable {
    ...
    public WpComments(long commentPostId, String commentAuthor, String commentAuthorEmail,
            String commentAuthorUrl, String commentAuthorIp, Date commentDate, Date commentDateGmt,
            String commentContent, int commentKarma, String commentApproved, String commentAgent,
