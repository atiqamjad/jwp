 ...
 */
@Entity
@Table(name = "wp_posts", catalog = "gads_wp")
public class WpPosts implements java.io.Serializable {
    ...
    public WpPosts(long postAuthor, Date postDate, Date postDateGmt, String postContent,
            String postTitle, String postExcerpt, String postStatus, String commentStatus,
