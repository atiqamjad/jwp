...
import com.samsonych.grabber.GAdsGrabberTest;
...
public class PosterTest extends AppJUnit4SpringContextTests {
	...
	public final void testGetPostFromFile() throws ServiceException {
		...
		Assert.assertEquals(GAdsGrabberTest.EXPECTED_POST_NAME,
				post.getPostName());
		Assert.assertEquals(GAdsGrabberTest.EXPECTED_TITLE, post.getPostTitle());
	}
